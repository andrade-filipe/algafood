...
insert into restaurante (nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, ativo) values ('Thai Gourmet', 10, 1, utc_timestamp, utc_timestamp, 1, '49400-000', 'Rua Whatever', '1000', 'Centro',true);
...
insert into restaurante (nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo) values ('Chatamiolé Comida Indiana', 5, 2, utc_timestamp, utc_timestamp,true);
